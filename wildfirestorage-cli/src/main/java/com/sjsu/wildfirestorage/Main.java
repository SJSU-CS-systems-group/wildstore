...
//            for (var fileName : fileNames) {
        ...
        public void clean(@CommandLine.Parameters(paramLabel = "limit") int limit,
            ...
            do {
                ...
                if (dryrun) {
                    System.out.println("The following Metadata documents would have been removed from the database:");
                } else {
                    System.out.println("The following Metadata documents have been removed from the database:");
